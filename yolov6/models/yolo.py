...
def build_network(config, channels, num_classes, num_layers, fuse_ab=False, distill_ns=False):
    ...
    channels_list = [make_divisible(i * width_mul, 8)
    ...
    if distill_ns:
        ...
        head = Detect(num_classes, num_layers,
                      head_layers=head_layers, use_dfl=use_dfl)
        ...
        head = Detect(num_classes, anchors_init, num_layers,
                      head_layers=head_layers, use_dfl=use_dfl)
